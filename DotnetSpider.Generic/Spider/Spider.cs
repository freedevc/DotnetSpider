...
//											$"Crawl {request.Url} failed and has been scheduled to retry.");
//								}
//								else
//								{
...
//			// [Doanh]: handle Empty Response or Failed 
//			if (page.Content == null) 
//			{
//				if (page.StatusCode == System.Net.HttpStatusCode.Found)
//				{
//					return new Tuple<bool?, int, int>(true,1, 0);
//				}
//				else
//				{
//					if (page.Retry)
...
//						return new Tuple<bool?, int, int>(null, 0, 0);
//					}
//					else
//					{
